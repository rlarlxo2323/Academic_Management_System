...
## 5. 실행 화면<br/>
### 사용자 화면<br/>
![사용자화면](image/사용자화면.PNG)<br/>

### 패스워드 변경<br/>
![패스워드](image/패스워드변경기능.PNG)<br/>

### 인원관리 기능(학사 담당)<br/>
![인원관리](image/인원관리.PNG)<br/>

### 학기관리 기능(수업 담당)<br/>
![학기개설](image/학기개설.PNG)<br/>

### 수강관련 기능(학생)<br/>
![수강신청](image/수강신청.PNG)<br/>

### 학점관리 기능(학생, 교수)<br/>
![학점관리](image/학점관리기능.PNG)<br/>
